...
input.error:focus {
  ...
  <body class="login-body">
    ...
    <div class="container">
      ...
      <form class="form-signin" id="adminForm" action="${BASE_PATH}/admin/login.json"  autocomplete="off" method="post">
        <h2 class="form-signin-heading"><img src="${BASE_PATH}/static/manage/images/logo.png" style="height:38px;"/></h2>
        <div class="login-wrap">
            ...
            <div>
                <input type="text" name="captcha" class="form-control" placeholder="验证码" style="width:100px;float:left;"> <img id="captcha" style="cursor:pointer;cursor:hand;margin-top: -13px;" onclick="this.src='${BASE_PATH}/admin/captcha.htm?'+Math.random();" src="${BASE_PATH}/admin/captcha.htm" >
            </div>
			...
			success : function(data) {
				if (data.result) {
					...
					if(data.msg=="change_captcha"){
						$('#captcha').attr("src","${BASE_PATH}/admin/captcha.htm?"+Math.random());
